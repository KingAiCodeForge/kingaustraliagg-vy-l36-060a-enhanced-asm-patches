...
This project exists to be a definitive, testable, falsifiable source of what works and what doesn't on the Delco 808 platform. RAM maps, hook points, patch methods, scope data, all in one place. No one should have to re-map RAM variables from scratch when someone already has the answers. The method needs to be defined clearly enough that it works for the old-school people who have done this before and the people trying to start in 2026 who can't find answers buried across 100-page forum threads at 10 posts per page.
